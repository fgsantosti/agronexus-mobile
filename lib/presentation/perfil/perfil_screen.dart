      ...
      child: BlocListener<UserBloc, UserState>(
        listener: (context, state) {
          ...
          if (state.status == UserStatus.loggedOut) {
            ...
            context.go(AgroNexusRouter.loginPath);
          }
        },
        child: BlocBuilder<UserBloc, UserState>(
          builder: (context, state) {
            ...
            // Mostrar indicador durante logout
            if (state.status == UserStatus.loading && _cachedUser != null) {
              return Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: user.isActive == true ? Colors.green.withOpacity(0.2) : Colors.orange.withOpacity(0.2),
                          ...
                          child: Text(
                            ...
                            style: theme.textTheme.bodySmall?.copyWith(
                              color: user.isActive == true ? Colors.green.shade700 : Colors.orange.shade700,
                  ...
                  _buildInfoCard(
                    ...
                    children: [
                      ...
                      _buildInfoItem(
                        ...
                        label: 'CPF',
                        value: user.cpf.isNotEmpty ? _cpfFormatter.maskText(user.cpf) : 'Não informado',
                      ),
                    ],
                  ),
                  ...
                  _buildInfoCard(
                    ...
                    children: [
                      ...
                      _buildInfoItem(
                        ...
                        value: user.createdAt != null ? _formatDate(user.createdAt!) : 'Não informado',
                      ),
